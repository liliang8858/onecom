...
- 当前章节：第 03 章，测试驱动的开发节奏，已完成。
- 当前学习文档：`docs/lessons/03-testing-rhythm.md`。
- 学员完成本章后，应能解释 Red/Green/Refactor、pytest 断言、异常测试、测试命名和小步验证。

## 下一步

下一章进入第 04 章：配置与环境变量基础。第 04 章会用一个简单配置对象讲清楚默认值、环境变量和 `.env.example`。
